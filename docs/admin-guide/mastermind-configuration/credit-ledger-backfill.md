...
Branch: develop
Remote Path: docs/admin/credit-ledger-backfill.md
Local Path: docs/admin-guide/mastermind-configuration
Last Sync: 2026-08-20T16:49:44.176763

WARNING: This file is automatically synchronized from the source repository.
DO NOT EDIT this file directly. Changes will be overwritten.
Edit the source at: https://code.opennodecloud.com/waldur/waldur-mastermind.git/-/tree/develop/docs/admin/credit-ledger-backfill.md
-->


# Backfilling the credit ledger

The [credit ledger](../../developer-guide/credit-ledger.md) only records movements made after it
