<!-- EXTERNAL DOCUMENT
Source: https://code.opennodecloud.com/waldur/waldur-docker-compose.git
Branch: develop
Remote Path: docs/matrix-chat-add-on.md/.
Local Path: docs/admin-guide/deployment/docker-compose/matrix-chat-add-on.md
Last Sync: 2026-06-11T18:54:10.215133

WARNING: This file is automatically synchronized from the source repository.
DO NOT EDIT this file directly. Changes will be overwritten.
Edit the source at: https://code.opennodecloud.com/waldur/waldur-docker-compose.git/-/tree/develop/docs/matrix-chat-add-on.md/.
-->
