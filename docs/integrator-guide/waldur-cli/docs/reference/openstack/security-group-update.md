...
Branch: main
Remote Path: docs//reference/openstack/security-group-update.md
Local Path: docs/integrator-guide/waldur-cli/docs/
Last Sync: 2026-07-25T20:18:59.860574

WARNING: This file is automatically synchronized from the source repository.
DO NOT EDIT this file directly. Changes will be overwritten.
Edit the source at: https://code.opennodecloud.com/waldur/waldur-cli.git/-/tree/main/docs//reference/openstack/security-group-update.md
-->


# `waldur-cli openstack security-group update`
...
```bash
waldur-cli openstack security-group update <UUID> (--request JSON | --request-file PATH | --generate-skeleton)
```
...
```bash
waldur-cli openstack security-group update --generate-skeleton
```
...
```bash
waldur-cli openstack security-group update <uuid> --request '{"description":null,"name":""}'
```
