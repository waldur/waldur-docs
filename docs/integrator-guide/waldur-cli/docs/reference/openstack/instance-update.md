...
Branch: main
Remote Path: docs//reference/openstack/instance-update.md
Local Path: docs/integrator-guide/waldur-cli/docs/
Last Sync: 2026-07-25T20:18:59.845476

WARNING: This file is automatically synchronized from the source repository.
DO NOT EDIT this file directly. Changes will be overwritten.
Edit the source at: https://code.opennodecloud.com/waldur/waldur-cli.git/-/tree/main/docs//reference/openstack/instance-update.md
-->


# `waldur-cli openstack instance update`
...
```bash
waldur-cli openstack instance update <UUID> (--request JSON | --request-file PATH | --generate-skeleton)
```
...
```bash
waldur-cli openstack instance update --generate-skeleton
```
...
```bash
waldur-cli openstack instance update <uuid> --request '{"description":null,"name":""}'
```
