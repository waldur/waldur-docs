...
Branch: main
Remote Path: docs//reference/openstack/volume-update.md
Local Path: docs/integrator-guide/waldur-cli/docs/
Last Sync: 2026-07-25T20:18:59.860038

WARNING: This file is automatically synchronized from the source repository.
DO NOT EDIT this file directly. Changes will be overwritten.
Edit the source at: https://code.opennodecloud.com/waldur/waldur-cli.git/-/tree/main/docs//reference/openstack/volume-update.md
-->


# `waldur-cli openstack volume update`
...
```bash
waldur-cli openstack volume update <UUID> (--request JSON | --request-file PATH | --generate-skeleton)
```
...
```bash
waldur-cli openstack volume update --generate-skeleton
```
...
```bash
waldur-cli openstack volume update <uuid> --request '{"bootable":null,"description":null,"name":""}'
```
