...
Last Sync: 2026-07-23T02:05:22.832133
...
edit them by hand, see that repo for how to regenerate. `src/main.rs`, `src/config.rs`,
`src/output.rs`, `src/pagination.rs`, and `src/http.rs` are hand-written and permanent.
