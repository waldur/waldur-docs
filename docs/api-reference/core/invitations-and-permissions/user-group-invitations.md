...
Last Sync: 2025-11-14T03:04:51.290776
...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/user-group-invitations/` | [List User Group Invitations](#list-user-group-invitations) |
| <span class="http-badge http-get">GET</span> | `/api/user-group-invitations/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/user-group-invitations/` | [Create](#create) |
| **Other Actions** | | |
| <span class="http-badge http-get">GET</span> | `/api/user-group-invitations/{uuid}/projects/` | [Return projects for group invitation](#return-projects-for-group-invitation) |
| <span class="http-badge http-post">POST</span> | `/api/user-group-invitations/{uuid}/cancel/` | [Cancel group invitation](#cancel-group-invitation) |
| <span class="http-badge http-post">POST</span> | `/api/user-group-invitations/{uuid}/submit_request/` | [Submit request](#submit-request) |

---
## Core CRUD


### List User Group Invitations
