...
Last Sync: 2025-11-14T11:10:19.015126
...
| <span class="http-badge http-post">POST</span> | `/api/users/{uuid}/pull_remote_user/` | [Pulls remote user data from eduTEAMS](#pulls-remote-user-data-from-eduteams) |
...
| **Other Actions** | | |
| <span class="http-badge http-get">GET</span> | `/api/users/me/` | [Get current user details, including authentication token](#get-current-user-details-including-authentication-token) |
| <span class="http-badge http-get">GET</span> | `/api/users/{uuid}/token/` | [Token](#token) |
| <span class="http-badge http-post">POST</span> | `/api/users/{uuid}/cancel_change_email/` | [Cancel email update request](#cancel-email-update-request) |
| <span class="http-badge http-post">POST</span> | `/api/users/{uuid}/change_email/` | [Allows to change email for user](#allows-to-change-email-for-user) |
| <span class="http-badge http-post">POST</span> | `/api/users/{uuid}/change_password/` | [Allows staff user to change password for any user](#allows-staff-user-to-change-password-for-any-user) |
| <span class="http-badge http-post">POST</span> | `/api/users/confirm_email/` | [Confirm email update using code](#confirm-email-update-using-code) |
| <span class="http-badge http-post">POST</span> | `/api/users/{uuid}/refresh_token/` | [Allows to refresh user auth token](#allows-to-refresh-user-auth-token) |
