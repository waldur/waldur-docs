...
Last Sync: 2025-11-13T03:04:19.132283
...
| <span class="http-badge http-get">GET</span> | `/api/customers/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/customers/` | [A new customer can only be created by users with staff privilege](#a-new-customer-can-only-be-created-by-users-with-staff-privilege) |
| <span class="http-badge http-put">PUT</span> | `/api/customers/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/customers/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/customers/{uuid}/` | [Delete](#delete) |
| **User Management** | | |
| <span class="http-badge http-get">GET</span> | `/api/customers/{uuid}/list_users/` | [List users](#list-users) |
| <span class="http-badge http-get">GET</span> | `/api/customers/{customer_uuid}/users/` | [A list of users connected to the customer](#a-list-of-users-connected-to-the-customer) |
| <span class="http-badge http-post">POST</span> | `/api/customers/{uuid}/add_user/` | [Add user](#add-user) |
| <span class="http-badge http-post">POST</span> | `/api/customers/{uuid}/delete_user/` | [Delete user](#delete-user) |
| <span class="http-badge http-post">POST</span> | `/api/customers/{uuid}/update_user/` | [Update user](#update-user) |
| **Compliance** | | |
| <span class="http-badge http-get">GET</span> | `/api/customers/{customer_uuid}/project-metadata-compliance-details/` | [Get detailed project compliance information with database-level pagination](#get-detailed-project-compliance-information-with-database-level-pagination) |
| <span class="http-badge http-get">GET</span> | `/api/customers/{customer_uuid}/project-metadata-compliance-overview/` | [Get compliance overview statistics for all projects](#get-compliance-overview-statistics-for-all-projects) |
| <span class="http-badge http-get">GET</span> | `/api/customers/{customer_uuid}/project-metadata-compliance-projects/` | [List project checklist answer data with database-level pagination](#list-project-checklist-answer-data-with-database-level-pagination) |
| <span class="http-badge http-get">GET</span> | `/api/customers/{customer_uuid}/project-metadata-question-answers/` | [List questions with project answers, paginated by question at database level](#list-questions-with-project-answers-paginated-by-question-at-database-level) |
| **Configuration & Updates** | | |
| <span class="http-badge http-post">POST</span> | `/api/customers/{uuid}/update_organization_groups/` | [Update organization groups for customer](#update-organization-groups-for-customer) |
| **Data & Reporting** | | |
| <span class="http-badge http-get">GET</span> | `/api/customers/countries/` | [Return list of countries](#return-list-of-countries) |
| <span class="http-badge http-get">GET</span> | `/api/customers/{uuid}/stats/` | [Return statistics about customer resources usage](#return-statistics-about-customer-resources-usage) |
