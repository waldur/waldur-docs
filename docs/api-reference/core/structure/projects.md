...
Last Sync: 2025-11-11T21:20:42.906230
...
| <span class="http-badge http-get">GET</span> | `/api/projects/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/projects/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/projects/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/projects/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/projects/{uuid}/` | [Delete](#delete) |
| **State Management** | | |
| <span class="http-badge http-post">POST</span> | `/api/projects/{uuid}/recover/` | [Recover a soft-deleted project with team member restoration](#recover-a-soft-deleted-project-with-team-member-restoration) |
| **User Management** | | |
...
| <span class="http-badge http-post">POST</span> | `/api/projects/{uuid}/move_project/` | [Move project](#move-project) |
| **Data & Reporting** | | |
| <span class="http-badge http-get">GET</span> | `/api/projects/{uuid}/stats/` | [Return statistics about project resources usage](#return-statistics-about-project-resources-usage) |
| **Checklists** | | |
...
=== "Python"
    ...
    response = projects_checklist_template_retrieve.sync(client=client)
