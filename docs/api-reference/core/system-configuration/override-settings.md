...
Last Sync: 2025-11-14T11:10:19.017492
...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/override-settings/` | [List Override Settings](#list-override-settings) |
| **Other Actions** | | |
| <span class="http-badge http-post">POST</span> | `/api/override-settings/` | [Settings](#settings) |

---
## Core CRUD


### List Override Settings
