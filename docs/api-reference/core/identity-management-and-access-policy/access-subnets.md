...
Last Sync: 2025-11-13T03:04:19.136613
...
| <span class="http-badge http-get">GET</span> | `/api/access-subnets/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/access-subnets/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/access-subnets/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/access-subnets/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/access-subnets/{uuid}/` | [Delete](#delete) |
