...
Last Sync: 2025-11-12T03:04:13.235879
...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/openstack-server-groups/` | [List Openstack Server Groups](#list-openstack-server-groups) |
| <span class="http-badge http-get">GET</span> | `/api/openstack-server-groups/{uuid}/` | [Retrieve](#retrieve) |
...
| <span class="http-badge http-delete">DELETE</span> | `/api/openstack-server-groups/{uuid}/` | [Delete](#delete) |
| **Other Actions** | | |
| <span class="http-badge http-post">POST</span> | `/api/openstack-server-groups/{uuid}/pull/` | [Pull](#pull) |
| <span class="http-badge http-post">POST</span> | `/api/openstack-server-groups/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
