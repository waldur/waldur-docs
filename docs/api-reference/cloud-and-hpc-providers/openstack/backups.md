...
Last Sync: 2025-11-11T21:20:42.926890
...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/openstack-backups/` | [List Openstack Backups](#list-openstack-backups) |
| <span class="http-badge http-get">GET</span> | `/api/openstack-backups/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-put">PUT</span> | `/api/openstack-backups/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/openstack-backups/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/openstack-backups/{uuid}/` | [Delete](#delete) |
| **Other Actions** | | |
| <span class="http-badge http-post">POST</span> | `/api/openstack-backups/{uuid}/pull/` | [Pull](#pull) |
...
| <span class="http-badge http-post">POST</span> | `/api/openstack-backups/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
