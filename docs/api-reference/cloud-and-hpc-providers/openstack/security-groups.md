...
Last Sync: 2025-11-12T03:04:13.237656
...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/openstack-security-groups/` | [List Openstack Security Groups](#list-openstack-security-groups) |
| <span class="http-badge http-get">GET</span> | `/api/openstack-security-groups/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-put">PUT</span> | `/api/openstack-security-groups/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/openstack-security-groups/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/openstack-security-groups/{uuid}/` | [Delete](#delete) |
| **Other Actions** | | |
| <span class="http-badge http-post">POST</span> | `/api/openstack-security-groups/{uuid}/pull/` | [Pull](#pull) |
| <span class="http-badge http-post">POST</span> | `/api/openstack-security-groups/{uuid}/set_rules/` | [Update security group rules](#update-security-group-rules) |
| <span class="http-badge http-post">POST</span> | `/api/openstack-security-groups/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
