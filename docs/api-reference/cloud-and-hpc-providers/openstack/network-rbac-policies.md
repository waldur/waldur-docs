...
Last Sync: 2025-11-16T03:04:22.721522
...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/openstack-network-rbac-policies/` | [List Openstack Network Rbac Policies](#list-openstack-network-rbac-policies) |
| <span class="http-badge http-get">GET</span> | `/api/openstack-network-rbac-policies/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/openstack-network-rbac-policies/` | [Create RBAC policy for the network](#create-rbac-policy-for-the-network) |
...
| <span class="http-badge http-delete">DELETE</span> | `/api/openstack-network-rbac-policies/{uuid}/` | [Delete RBAC policy for the network](#delete-rbac-policy-for-the-network) |
