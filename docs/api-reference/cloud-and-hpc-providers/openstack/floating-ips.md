...
Last Sync: 2025-11-14T03:04:51.317776
...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/openstack-floating-ips/` | [List Openstack Floating Ips](#list-openstack-floating-ips) |
| <span class="http-badge http-get">GET</span> | `/api/openstack-floating-ips/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/openstack-floating-ips/{uuid}/update_description/` | [Update description of the floating IP](#update-description-of-the-floating-ip) |
| <span class="http-badge http-delete">DELETE</span> | `/api/openstack-floating-ips/{uuid}/` | [Delete](#delete) |
| **Other Actions** | | |
| <span class="http-badge http-post">POST</span> | `/api/openstack-floating-ips/{uuid}/attach_to_port/` | [Attach floating IP to port](#attach-floating-ip-to-port) |
...
| <span class="http-badge http-post">POST</span> | `/api/openstack-floating-ips/{uuid}/pull/` | [Pull](#pull) |
| <span class="http-badge http-post">POST</span> | `/api/openstack-floating-ips/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
