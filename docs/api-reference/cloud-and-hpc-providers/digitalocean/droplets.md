...
Last Sync: 2025-11-11T21:20:42.919500
...
| **Other Actions** | | |
| <span class="http-badge http-post">POST</span> | `/api/digitalocean-droplets/{uuid}/pull/` | [Pull](#pull) |
...
| <span class="http-badge http-post">POST</span> | `/api/digitalocean-droplets/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
