...
Last Sync: 2025-11-11T21:20:42.915563
...
| <span class="http-badge http-post">POST</span> | `/api/rancher-hpas/{uuid}/pull/` | [Pull](#pull) |
| <span class="http-badge http-post">POST</span> | `/api/rancher-hpas/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
