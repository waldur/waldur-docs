...
Last Sync: 2025-11-13T03:04:19.141762
...
| <span class="http-badge http-post">POST</span> | `/api/rancher-ingresses/{uuid}/pull/` | [Pull](#pull) |
| <span class="http-badge http-post">POST</span> | `/api/rancher-ingresses/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
