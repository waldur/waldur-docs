...
Last Sync: 2025-11-14T03:04:51.300584
...
| <span class="http-badge http-post">POST</span> | `/api/aws-volumes/{uuid}/pull/` | [Pull](#pull) |
| <span class="http-badge http-post">POST</span> | `/api/aws-volumes/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
