...
Last Sync: 2025-11-11T21:20:42.923102
...
| **Other Actions** | | |
| <span class="http-badge http-post">POST</span> | `/api/vmware-ports/{uuid}/pull/` | [Pull](#pull) |
| <span class="http-badge http-post">POST</span> | `/api/vmware-ports/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
