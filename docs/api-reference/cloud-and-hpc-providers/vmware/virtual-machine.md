...
Last Sync: 2025-11-14T03:04:51.311876
...
| <span class="http-badge http-post">POST</span> | `/api/vmware-virtual-machine/{uuid}/pull/` | [Pull](#pull) |
...
| <span class="http-badge http-post">POST</span> | `/api/vmware-virtual-machine/{uuid}/unlink/` | [Delete resource from the database without scheduling operations on backend](#delete-resource-from-the-database-without-scheduling-operations-on-backend) |
