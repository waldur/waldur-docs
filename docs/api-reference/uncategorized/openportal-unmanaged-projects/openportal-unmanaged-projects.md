...
Branch: main
Remote Path: output//uncategorized/openportal-unmanaged-projects/openportal-unmanaged-projects.md
Local Path: docs/api-reference/
Last Sync: 2025-11-14T03:04:51.322924

WARNING: This file is automatically synchronized from the source repository.
DO NOT EDIT this file directly. Changes will be overwritten.
Edit the source at: https://code.opennodecloud.com/waldur/waldur-sdk-docs-generator.git/-/tree/main/output//uncategorized/openportal-unmanaged-projects/openportal-unmanaged-projects.md
-->
...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/openportal-unmanaged-projects/` | [List Openportal Unmanaged Projects](#list-openportal-unmanaged-projects) |
| <span class="http-badge http-get">GET</span> | `/api/openportal-unmanaged-projects/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/openportal-unmanaged-projects/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/openportal-unmanaged-projects/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/openportal-unmanaged-projects/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/openportal-unmanaged-projects/{uuid}/` | [Delete](#delete) |
| **Permissions & Users** | | |
| <span class="http-badge http-get">GET</span> | `/api/openportal-unmanaged-projects/{uuid}/list_users/` | [List users](#list-users) |
| <span class="http-badge http-post">POST</span> | `/api/openportal-unmanaged-projects/{uuid}/add_user/` | [Add user](#add-user) |
| <span class="http-badge http-post">POST</span> | `/api/openportal-unmanaged-projects/{uuid}/delete_user/` | [Delete user](#delete-user) |
| <span class="http-badge http-post">POST</span> | `/api/openportal-unmanaged-projects/{uuid}/update_user/` | [Update user](#update-user) |
| **Other Actions** | | |
...
| <span class="http-badge http-get">GET</span> | `/api/openportal-unmanaged-projects/{uuid}/stats/` | [Return statistics about project resources usage](#return-statistics-about-project-resources-usage) |
| <span class="http-badge http-post">POST</span> | `/api/openportal-unmanaged-projects/{uuid}/move_project/` | [Move project](#move-project) |
| <span class="http-badge http-post">POST</span> | `/api/openportal-unmanaged-projects/{uuid}/recover/` | [Recover a soft-deleted project with team member restoration](#recover-a-soft-deleted-project-with-team-member-restoration) |
...
### List Openportal Unmanaged Projects
