...
Last Sync: 2025-12-13T03:04:20.361061
...
| <span class="http-badge http-post">POST</span> | `/api/user-actions/update_actions/` | [Trigger update of user actions (admin only)](#trigger-update-of-user-actions-admin-only) |
| **Other Actions** | | |
