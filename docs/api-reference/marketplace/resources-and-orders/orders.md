...
Last Sync: 2025-11-18T03:04:10.736489
...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-orders/` | [List Marketplace Orders](#list-marketplace-orders) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-orders/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/` | [Create](#create) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/unlink/` | [Unlink](#unlink) |
| <span class="http-badge http-delete">DELETE</span> | `/api/marketplace-orders/{uuid}/` | [Delete](#delete) |
| **State Management** | | |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/approve_by_consumer/` | [Approve by consumer](#approve-by-consumer) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/approve_by_provider/` | [Approve by provider](#approve-by-provider) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/cancel/` | [Cancel](#cancel) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/reject_by_consumer/` | [Reject by consumer](#reject-by-consumer) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/reject_by_provider/` | [Reject by provider](#reject-by-provider) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/set_state_done/` | [Set state done](#set-state-done) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/set_state_erred/` | [Set state erred](#set-state-erred) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/set_state_executing/` | [Set state executing](#set-state-executing) |
| **Configuration & Updates** | | |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/delete_attachment/` | [Delete the attachment from a pending order](#delete-the-attachment-from-a-pending-order) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/set_backend_id/` | [Set backend id](#set-backend-id) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-orders/{uuid}/update_attachment/` | [Update the attachment for a pending order](#update-the-attachment-for-a-pending-order) |
| **Data & Reporting** | | |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-orders/{uuid}/offering/` | [Offering](#offering) |
