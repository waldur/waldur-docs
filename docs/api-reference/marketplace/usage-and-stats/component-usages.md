...
Last Sync: 2025-11-27T03:04:11.549201
...
=== "Request Body (required)"
    ...
    | `usages.recurring` | boolean |  | <br>_Constraints: default: `False`_ |
    | `plan_period` | string (uuid) |  |  |
    | `resource` | string (uuid) |  |  |
    | `date` | string (date-time) |  | Date for usage reporting (staff only). If not provided, current date is used. |
