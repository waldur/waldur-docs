...
Last Sync: 2025-11-14T21:54:00.960764
...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/maintenance-announcement-template-offerings/` | [List Maintenance Announcement Template Offerings](#list-maintenance-announcement-template-offerings) |
| <span class="http-badge http-get">GET</span> | `/api/maintenance-announcement-template-offerings/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/maintenance-announcement-template-offerings/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/maintenance-announcement-template-offerings/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/maintenance-announcement-template-offerings/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/maintenance-announcement-template-offerings/{uuid}/` | [Delete](#delete) |
