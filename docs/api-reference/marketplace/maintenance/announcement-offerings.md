...
Last Sync: 2025-11-17T13:04:30.663064
...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/maintenance-announcement-offerings/` | [List Maintenance Announcement Offerings](#list-maintenance-announcement-offerings) |
| <span class="http-badge http-get">GET</span> | `/api/maintenance-announcement-offerings/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/maintenance-announcement-offerings/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/maintenance-announcement-offerings/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/maintenance-announcement-offerings/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/maintenance-announcement-offerings/{uuid}/` | [Delete](#delete) |
