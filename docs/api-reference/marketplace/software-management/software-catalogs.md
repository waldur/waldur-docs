...
Last Sync: 2025-11-15T03:04:20.421504
...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-software-catalogs/` | [List Marketplace Software Catalogs](#list-marketplace-software-catalogs) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-software-catalogs/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-software-catalogs/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/marketplace-software-catalogs/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/marketplace-software-catalogs/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/marketplace-software-catalogs/{uuid}/` | [Delete](#delete) |

---

### List Marketplace Software Catalogs
