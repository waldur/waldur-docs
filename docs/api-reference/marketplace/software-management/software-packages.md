...
Last Sync: 2025-11-17T03:04:11.439805
...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-software-packages/` | [List Marketplace Software Packages](#list-marketplace-software-packages) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-software-packages/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-software-packages/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/marketplace-software-packages/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/marketplace-software-packages/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/marketplace-software-packages/{uuid}/` | [Delete](#delete) |
