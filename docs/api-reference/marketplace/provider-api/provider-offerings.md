...
Last Sync: 2025-11-14T21:54:00.958798
...
| <span class="http-badge http-get">GET</span> | `/api/marketplace-provider-offerings/{uuid}/list_users/` | [List users](#list-users) |
...
| <span class="http-badge http-post">POST</span> | `/api/marketplace-provider-offerings/{uuid}/add_user/` | [Add user](#add-user) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-provider-offerings/{uuid}/delete_user/` | [Delete user](#delete-user) |
...
| <span class="http-badge http-post">POST</span> | `/api/marketplace-provider-offerings/{uuid}/update_user/` | [Update user](#update-user) |
| **Offering Components** | | |
