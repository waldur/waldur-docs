...
Last Sync: 2025-12-07T23:35:13.986780
...
=== "Request Body (required)"
    ...
    | `preserve_state` | boolean |  | Preserve offering state from export, otherwise set to 'Draft'<br>_Constraints: default: `False`_ |
...
=== "Responses"
    ...
    **`200`** - 
    ...
    | Field | Type | Description |
    |---|---|---|
    | `imported_offering_uuid` | string (uuid) |  |
    ...
    | `import_timestamp` | string (date-time) |  |
