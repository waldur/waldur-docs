...
Last Sync: 2025-11-17T14:33:12.854824
...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/course_accounts/` | [Course accounts](#course-accounts) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/customer_projects/` | [Return customer projects of service provider](#return-customer-projects-of-service-provider) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/customers/` | [Return customers of service provider](#return-customers-of-service-provider) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/keys/` | [Return SSH keys of service provider](#return-ssh-keys-of-service-provider) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/` | [List Marketplace Service Providers](#list-marketplace-service-providers) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{uuid}/list_users/` | [List users](#list-users) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/offerings/` | [Return offerings of service provider](#return-offerings-of-service-provider) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/project_permissions/` | [Return project permissions of service provider](#return-project-permissions-of-service-provider) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/project_service_accounts/` | [Project service accounts](#project-service-accounts) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/projects/` | [Return projects of service provider](#return-projects-of-service-provider) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{uuid}/revenue/` | [Revenue](#revenue) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{uuid}/robot_account_customers/` | [Robot account customers](#robot-account-customers) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{uuid}/robot_account_projects/` | [Robot account projects](#robot-account-projects) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{uuid}/stat/` | [Stat](#stat) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/user_customers/` | [User customers](#user-customers) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/users/` | [Return users of service provider](#return-users-of-service-provider) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{uuid}/api_secret_code/` | [Return service provider API secret code](#return-service-provider-api-secret-code) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/compliance/checklists_summary/` | [Checklists summary](#checklists-summary) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/compliance/compliance_overview/` | [Compliance overview](#compliance-overview) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-service-providers/{service_provider_uuid}/compliance/offering_users/` | [List offering users with their compliance status for this service provider](#list-offering-users-with-their-compliance-status-for-this-service-provider) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-service-providers/{uuid}/add_user/` | [Add user](#add-user) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-service-providers/` | [Create](#create) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-service-providers/{uuid}/delete_user/` | [Delete user](#delete-user) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-service-providers/{uuid}/set_offerings_username/` | [Set offerings username](#set-offerings-username) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-service-providers/{uuid}/update_user/` | [Update user](#update-user) |
...
| <span class="http-badge http-put">PUT</span> | `/api/marketplace-service-providers/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/marketplace-service-providers/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/marketplace-service-providers/{uuid}/` | [Delete](#delete) |
