...
Last Sync: 2025-11-12T03:04:13.169923
...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-category-components/` | [List Marketplace Category Components](#list-marketplace-category-components) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-category-components/{id}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-category-components/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/marketplace-category-components/{id}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/marketplace-category-components/{id}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/marketplace-category-components/{id}/` | [Delete](#delete) |
