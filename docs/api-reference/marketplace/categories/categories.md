...
Last Sync: 2025-11-11T21:20:42.855367
...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-categories/` | [List Marketplace Categories](#list-marketplace-categories) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-categories/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-categories/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/marketplace-categories/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/marketplace-categories/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/marketplace-categories/{uuid}/` | [Delete](#delete) |
