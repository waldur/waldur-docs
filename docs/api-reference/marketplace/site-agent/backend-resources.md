...
Last Sync: 2025-11-17T19:50:43.616733
...
| <span class="http-badge http-get">GET</span> | `/api/backend-resources/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/backend-resources/` | [Create](#create) |
| <span class="http-badge http-delete">DELETE</span> | `/api/backend-resources/{uuid}/` | [Delete](#delete) |
| **Other Actions** | | |
| <span class="http-badge http-post">POST</span> | `/api/backend-resources/{uuid}/import_resource/` | [Import resource](#import-resource) |
