...
Last Sync: 2025-11-17T03:04:11.469074
...
| **Permissions & Users** | | |
| <span class="http-badge http-get">GET</span> | `/api/call-managing-organisations/{uuid}/list_users/` | [List users](#list-users) |
| <span class="http-badge http-post">POST</span> | `/api/call-managing-organisations/{uuid}/add_user/` | [Add user](#add-user) |
| <span class="http-badge http-post">POST</span> | `/api/call-managing-organisations/{uuid}/delete_user/` | [Delete user](#delete-user) |
| <span class="http-badge http-post">POST</span> | `/api/call-managing-organisations/{uuid}/update_user/` | [Update user](#update-user) |
| **Other Actions** | | |
