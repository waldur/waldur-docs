...
Last Sync: 2025-11-14T03:04:51.278788
...
| **Permissions & Users** | | |
| <span class="http-badge http-get">GET</span> | `/api/proposal-protected-calls/{uuid}/list_users/` | [List users](#list-users) |
| <span class="http-badge http-post">POST</span> | `/api/proposal-protected-calls/{uuid}/add_user/` | [Add user](#add-user) |
| <span class="http-badge http-post">POST</span> | `/api/proposal-protected-calls/{uuid}/delete_user/` | [Delete user](#delete-user) |
| <span class="http-badge http-post">POST</span> | `/api/proposal-protected-calls/{uuid}/update_user/` | [Update user](#update-user) |
| **Other Actions** | | |
