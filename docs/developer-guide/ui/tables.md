...
Add `hasOptionalColumns` prop to enable optional columns functionality. For actions column, you can specify mandatory fields that should always be fetched from API using `mandatoryFields` prop.
